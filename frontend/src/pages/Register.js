    ...
    <div className="auth-page auth-centered">
      <section className="auth-card auth-card-centered">
        ...
        <form onSubmit={submit} className="form-stack">
          ...
          <label>Código de invitación<input value={form.referralCode} onChange={(e) => setForm({ ...form, referralCode: e.target.value })} placeholder="Código de invitación" /></label>

          <div className="captcha-box">
            <div>
              <span>El código es...</span>
            ...
            <input
              ...
              maxLength="6"
              value={captchaAnswer}
              onChange={(e) => setCaptchaAnswer(e.target.value.replace(/[^a-zA-Z]/g, "").toUpperCase().slice(0, 6))}
              placeholder="Código"
          ...
          <button className="primary-btn" disabled={loading}>{loading ? "Registrando..." : "Registrar"}</button>
        </form>
